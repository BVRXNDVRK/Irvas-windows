...
var changeModalState = function changeModalState(state) {
  ...
  function disableNextbutton(inputsSelector, buttonSelector) {
    ...
    var someMethodResult = inputValues.some(function (value) {
      return value == '';
    });
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              ...
              elem.forEach(function (box, j) {
                ...
                var profileButton = document.querySelector('.popup_calc_profile_button');
...
var images = function images() {
  ...
  bigImageWrapper.style.cssText = "\n    height: ".concat(window.innerHeight * 0.8, "px;\n    max-width: ").concat(window.innerWidth * 0.8, "px;\n    overflow: hidden;\n  ");
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  function showTabContent() {
    ...
    content[i].classList.add('animated', 'bounceIn');
